...
public class createJobApiDataDrivenTest {
    ...
    @Test(description ="Verifying the create Job api is able to create the inwarrenty job" ,groups = {"api","regression","smoke","dataDriven"},dataProviderClass = com.dataproviders.dataproviderUtils.class,dataProvider = "CreateJobAPIDataProvider")
