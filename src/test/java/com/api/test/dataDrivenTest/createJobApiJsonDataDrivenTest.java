...
public class createJobApiJsonDataDrivenTest {
    ...
    @Test(description ="Verifying the create Job api is able to create the inwarrenty job" ,groups = {"api","regression","smoke","dataDriven","faker"},dataProviderClass = com.dataproviders.dataproviderUtils.class,dataProvider = "CreateJobAPiJsonDataProvider")
